...
pdf_path = '/home/abhinav_baiju/Documents/LoF/project4/lof-sims-interns/BeacherSally2024610.pdf'
case = extract_text_pypdf2(pdf_path)

start_time = time.time()
prompt = f"Extract relevant information for the following fields from the given case: \n{case}"
